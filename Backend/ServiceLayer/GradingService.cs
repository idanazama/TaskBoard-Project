...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        {
            return wrapperService.userService.GetUserBoards(email);
        }
        ...
        {
            return wrapperService.boardService.JoinBoard(email, boardID);
        }
        ...
        {
            return wrapperService.boardService.LeaveBoard(email, boardID);
        }
        ...
        {
            return wrapperService.taskService.AssignTask(email,boardName,columnOrdinal,taskID,emailAssignee);
        }
        ...
        {
            return wrapperService.boardService.GetBoardName(boardId);
        }
        ...
        {
            return wrapperService.boardService.TransferOwnership(currentOwnerEmail, newOwnerEmail, boardName);
        }
        ...
        {
            return wrapperService.LoadAllData();
        }
        ...
        {
            return wrapperService.DeleteData();
        }
    }
}
